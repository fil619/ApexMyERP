<template>
    <div class="container-fluid">
        <ol class="breadcrumb">
            ...
            <li class="active"><i class="fas fa-tools"></i> Servicing</li>
        </ol>
        <div class="row">
                ...
                <div class="panel-group" id="accordion">
                                ...
                                <form @keydown.enter.prevent>
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-8 col-sm-12 col-xs-8">
                                            ...
                                            <input type="text" class="form-control" id="vehicleNo" placeholder="GA 08 M 4328" @keydown.ctrl.space.prevent="startBill" @keydown.enter.prevent="getBill" v-model="customer.vehicle_no" @blur="parseVehicleNo">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6 col-sm-12 col-xs-6">
                                            <label for="name">Name</label>
                                            <input type="text" class="form-control" id="name" placeholder="Rohan Naik" @keydown.ctrl.space.prevent="startBill" v-model="customer.name" @blur="customer.name = parseNameField(customer.name)">
                                        </div>
                                        <div class="form-group col-md-6 col-sm-12 col-xs-6">
                                            <label for="mobile">Contact</label>
                                            <input type="text" class="form-control" id="mobile" placeholder="9822XXXXX0" @keydown.enter.prevent="getBill" @keydown.ctrl.space.prevent="startBill" v-model="customer.mobile">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6 col-sm-12 col-xs-8">
                                            <label for="gst">GST No.</label>
                                            <input type="text" class="form-control" id="gst" placeholder="30XXXXXXXXXX2Z5" v-model="customer.gst_no" @keydown.ctrl.space.prevent="startBill">
                                        </div>
                                        <div class="form-group col-md-6 col-sm-12 col-xs-8">
                                            <label for="mechanic">Mechanic</label>
                                            <select class="form-control" id="mechanic" v-model="repair.employee_id" @keydown.ctrl.space.prevent="startBill">
                                                <option v-for="mechanic in mechanics" v-bind:key="mechanic.id" v-bind:value="mechanic.id">{{mechanic.first_name}} {{mechanic.last_name}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row">
                    ...
                    <div class="panel panel-apex">
                        ...
                        <div id="collapse2" class="panel-collapse collapse">
                            <div class="panel-body">
                                <form @keydown.enter.prevent  @keydown.ctrl.space.prevent="addPart">
                                    <div class="row">
                                        <div class="form-group col-md-4 col-sm-12 col-xs-4">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4 col-sm-6 col-xs-4">
                                            ...
                                            <input type="number" class="form-control" id="quantity" placeholder="2" required  v-model="sale.quantity">
                                        </div>
                                        <div class="form-group col-md-4 col-sm-6 col-xs-4">
                                            <label for="mrp">MRP</label>
                                            <input type="number" class="form-control" id="mrp" placeholder="120.00" required v-model="sale.sell_mrp">
                                        </div>
                                        <div class="form-group col-md-4 col-sm-6 col-xs-4">
                    ...
                    <div class="panel panel-apex">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapse3">Servicing Details</a>
                            </h4>
                        </div>
                        <div id="collapse3" class="panel-collapse collapse">
                            <div class="panel-body">
                                <form @keydown.enter.prevent @keydown.ctrl.space.prevent="updateRepair">
                                    <div class="row">
                                        <div class="form-group col-md-9 col-sm-12 col-xs-9">
                                            <label for="serviceDetail">Servicing Done</label>
                                            <input type="text" class="form-control" id="serviceDetail" placeholder="Servicing Done" v-model="repair.service_detail">
                                        </div>
                                        <div class="form-group col-md-3 col-sm-12 col-xs-3">
                                            <label for="serviceCharge">Service Charge</label>
                                            <input type="number" class="form-control" id="serviceCharge" placeholder="240.00" v-model="repair.service_charge" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-9 col-sm-12 col-xs-9">
                                            <label for="otherDetail">Other Works</label>
                                            <input type="text" class="form-control" id="otherDetail" placeholder="Washinng" v-model="repair.other_detail">
                                        </div>
                                        <div class="form-group col-md-3 col-sm-12 col-xs-3">
                                            <label for="otherCharge">Other Charge</label>
                                            <input type="number" class="form-control" id="otherCharge" placeholder="100.00" v-model="repair.other_charge" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-offset-3 col-md-3 col-sm-offset-1 col-sm-5 col-xs-6">
                                            <button type="submit" class="btn btn-success" @click.prevent="updateRepair"><i class="fas fa-cart-plus"></i> Add Repair</button>
                                        </div>
                                        <div class="form-group col-md-3 col-sm-5 col-xs-6">
                                            <button type="submit" class="btn btn-warning" @click.prevent="updateRepair"><i class="fas fa-sync-alt"></i> Update Repair</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                ...
                                <form @keydown.enter.prevent="updatePayment" @keydown.ctrl.space.prevent="updatePayment">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4 col-sm-6 col-xs-4">
                                            ...
                                            <input type="number" class="form-control" id="advance" placeholder="500.00" v-model="bill.advance">
                                        </div>
                                        <div class="form-group col-md-4 col-sm-6 col-xs-4">
                                            <label for="balance">Balance</label>
                                            <input type="number" class="form-control" id="balance" placeholder="748.00" v-model="bill.balance">
                                        </div>
                                    <!-- </div>
                                    <div class="row"> -->
                                        <div class="form-group col-md-4 col-sm-6 col-xs-4">
                                            <label for="discount">Discount</label>
                                            <input type="number" class="form-control" id="discount" placeholder="48.00" v-model="bill.discount">
                                        </div>
                                        <div class="form-group col-md-4 col-sm-6 col-xs-4">
                                            <label for="received">Received</label>
                                            <input type="number" class="form-control" id="received" placeholder="1000.00" v-model="bill.paid">
                                        </div>
                                        <div class="form-group col-md-4 col-sm-6 col-xs-4">
                                            <label for="return">Return</label>
                                            <input type="number" class="form-control" id="return" placeholder="300.00" v-model="bill.returnable">
                                        </div>
                                    </div>
                                    <div class="row ">
                                        <div class="form-group col-md-offset-3 col-md-3 col-sm-offset-1 col-sm-5 col-xs-offset-1 col-xs-4">
            ...
            <div class="col-sm-6" id="bill-display">
                <button id="print-btn" @click.prevent="printBill"><i class="fas fa-print"></i> Print</button>
                <div class="row">
                    ...
                    <div class="col-sm-5">Mech: </div>

                    <div class="col-sm-offset-2 col-sm-5">GST #: {{customer.gst_no}}</div>
                </div>
                <div class="row">
                ...
                <div class="row text-center">
                    <div class="col-sm-4 payable">Payable
                        <span class="number"><i class="fas fa-rupee-sign"></i>{{this.bill.balance}}</span>
                    </div>
                    <div class="col-sm-4 paid">Paid
                        <span class="number"><i class="fas fa-rupee-sign"></i>{{this.bill.paid}}</span>
                    </div>
                    <div class="col-sm-4 return">Return
                        <span class="number"><i class="fas fa-rupee-sign"></i>{{this.bill.returnable}}</span>
                    </div>
                </div>
                <div class="row font-bold text-center line">
                    <div class="col-xs-1">#</div>
                    <div class="col-xs-5">Particulars</div>
                    <div class="col-xs-1">Qty.</div>
                    <div class="col-xs-2">Rate</div>
                    <div class="col-xs-1">GST</div>
                    <div class="col-xs-2">Amt</div>
                </div>
                ...
                <div class="row line">
                    <div class="col-xs-10 text-right">
                        ...
                        <small>( {{this.repair.service_detail}} )</small>
                    </div>
                    <div class="col-xs-2">{{this.repair.service_charge}}</div>
                </div>
                <div class="row line">
                    <div class="col-xs-10 text-right">
                        <strong>Other Charge</strong>
                        <small>( {{this.repair.other_detail}} )</small>
                    </div>
                    <div class="col-xs-2">{{this.repair.other_charge}}</div>
                </div>
                <div class="row line">
                    <div class="col-xs-10 text-right">
                        <strong>Sub-total</strong>
                    </div>
                    <div class="col-xs-2">{{this.bill.sub_total}}</div>
                </div>
                <div class="row line">
                    <div class="col-xs-10 text-right">
                        <strong>Discount</strong>
                    </div>
                    <div class="col-xs-2">{{this.bill.discount}}</div>
                </div>
                <div class="row line">
                    <div class="col-xs-10 text-right">
                        <strong>Total</strong>
                    </div>
                    <div class="col-xs-2">{{this.bill.grand_total}}</div>
                </div>
                <div class="row line">
                    <div class="col-xs-10 text-right">
                        <strong>Advance</strong>
                    </div>
                    <div class="col-xs-2">{{this.bill.advance}}</div>
                </div>
            </div>
...
<script>
    export default {
        mounted(){
            axios.get('/getMechanics').then(response => {
                this.mechanics = response.data;
            });
            this.bill.type = 'servicing';
            ...
            window.addEventListener('keydown', function(e){
                if(e.ctrlKey && e.keyCode==49){
                    ...
                    e.preventDefault();
                    document.querySelectorAll('a[href^="#collapse3"]')[0].click();
                    document.getElementById("serviceDetail").focus();
        ...
        methods: {
                    ...
                    axios.post('/addCustomer', this.customer).then(response => {
                        ...
                        axios.post('/getBill', {customer_id: this.customer.id, type: this.bill.type}).then(response => {
                            if(response.data == 0){
                                ...
                                this.repair.bill_id = this.bill.id;
                                axios.post('/startRepair', this.repair).then(response => {
            ...
            startBill: function(){
                if((this.customer.mobile || this.customer.vehicle_no) && this.repair.employee_id){
                    if(this.customer.name){
                        this.customer.name = this.parseNameField(this.customer.name);
                    }
                    if(this.customer.vehicle_no){
            ...
            updateRepair: function(){
                axios.post('/updateRepair', this.repair).then(response => {
                    axios.post('/updateBill', this.bill).then(response => {
                        this.bill = response.data;
                    });
                });
